defmodule ReadingListWeb.MediaControllerTest do
  use ReadingListWeb.ConnCase

  alias ReadingList.ReadingList

  @create_attrs %{author: "some author", description: "some description", link: "some link", title: "some title"}
  ...
  def fixture(:media) do
    {:ok, media} = ReadingList.create_media(@create_attrs)
    media
  end
